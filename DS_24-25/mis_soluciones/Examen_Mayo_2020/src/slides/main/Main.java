...
public class Main 
{
    ...
    void config2()
    {
        ...
        Layout titleLayout = new Layout(LayoutType.NORMAL);
        ...
        Layout titleAndContentLayout = new Layout(LayoutType.NORMAL);
        ...
        //    tipo GRID
        Layout titleBulletsAndPictureLayout = new Layout(LayoutType.GRID);
