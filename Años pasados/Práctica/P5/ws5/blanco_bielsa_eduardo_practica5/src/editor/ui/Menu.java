...
public class Menu 
{
	...
	private void askUser() throws IOException
	{
		...
		if (action.equals("soltar")) {
			...
			editor.drawDocument();
		} else if(action.equals("deshacer")) {//nueva opción: deshacer
			editor.undoElement();
		}else if(action.equals("repetir")) {//nueva opción: repetir
			editor.repeatElement();
	...
	public static Map<String, Tool> getToolsCreated() {
		return tools;
	}
}
