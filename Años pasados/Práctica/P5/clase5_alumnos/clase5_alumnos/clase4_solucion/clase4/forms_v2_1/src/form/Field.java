...
public class Field 
{
	...
	public static final Validator POSTAL_CODE = new PostalCodeValidator();
	...
	public void askUser()
	{
		...
		while (true) {
			try {
				...
				System.out.print("El valor introducido para \"" + label + "\" no es válido: " + value);
				System.out.println(" (se esperaba un valor " + validator.getMessage() + ")");
			} catch (IOException e) {
