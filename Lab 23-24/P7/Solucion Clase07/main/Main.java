...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Otra forma de hacerlo:
        fs.copy("privado.txt",
                antes = new Contador(new Normalizador(despues = new Contador((new InternetOutput("1.1.1.1"))))));
        System.out.println("Modificacion 4b: " + antes.getCounter() + " -> " + despues.getCounter());

        // ------------------------------------------------
        // Modificación 5: Se quiere que un fichero se encripte solo una vez aunque se
        // envíe a más de un destino.
        // Cambios: Añadir clase Repartidor.
        fs.copy("privado.txt",
                new Encriptador(new Repartidor(new InternetOutput("1.1.1.1"), new BluetoothOutput("iPhone"))));
